...
import edu.njau.SmartAgriculture.utils.TDevice;
...
public class TitleBar extends FrameLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null) {
            ...
            boolean isSearch = a.getBoolean(R.styleable.TitleBar_aIsSearch, false);
            a.recycle();
            ...
            if (isSearch) {
                ...
                initNormal(inflater, true);
            }
        } else {
            initNormal(inflater, false);
        }
    ...
    private void initSearch(LayoutInflater inflater) {
        inflater.inflate(R.layout.lay_title_bar_search, this, true);
    }

    private void initNormal(LayoutInflater inflater, boolean hasAttrs) {
