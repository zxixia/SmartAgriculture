...
public class MovieStarView extends View {
    ...
    private int measureWidth(int measureSpec, float density) {
        ...
        if (specMode == MeasureSpec.EXACTLY && specSize > 0) {
            ...
            // 指定最小宽度
            // 04-18 17:33:02.814 D/xixia-1 ( 9173): [1][DogFood][2       ][  124][measureWidth][MovieStarView][density * 50: 150.0, specSize: 1080]
            // 04-18 17:33:02.814 D/xixia-1 ( 9173): [1][DogFood][3       ][  145][measureHeight][MovieStarView][density * 15: 45.0, specSize: 1776]
            // 这里传的是父控件的大小
            // 所以要取最小值
