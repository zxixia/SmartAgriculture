...
public class FarmingOperationPresenter implements FarmingOperationContract.Presenter {

    FarmingOperationContract.View mView;
    public FarmingOperationPresenter(FarmingOperationContract.View view) {
        mView = view;
