...
import edu.njau.SmartAgriculture.widgets.RecyclerRefreshLayout;

/**
 * 参考BaseRecyclerFragment
 * 增加了顶部的一个Weather或者是检索的面板
 */
public abstract class SARecyclerFragment<Presenter extends BaseListPresenter, Model> extends BaseFragment
